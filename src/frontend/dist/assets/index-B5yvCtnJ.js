...
function CustomCursor() {
  ...
  const isHover = reactExports.useRef(false);
  const visible = reactExports.useRef(false);
  reactExports.useEffect(() => {
...
const CASE_STUDIES = [
  {
    ...
    objective: "Grow an Instagram presence from scratch — zero follower base, no content library, no brand awareness.",
    problem: "The brand had no social presence, inconsistent visual identity, and no content pipeline. Engagement was non-existent and there was no strategy to build an audience organically.",
    funnelDesign: "TOF: Reels + hashtag discovery to attract cold audiences. MOF: Carousel posts + story interactions to build trust and nurture. BOF: Strong CTAs, DMs, and link-in-bio to convert.",
    channelsUsed: [
      "Instagram (Organic)",
      "Stories",
      "Reels",
    ...
    creativeApproach: "Built a 4-pillar content system: Education · Entertainment · Emotion · Engagement. Each pillar had dedicated formats (Reels, carousels, quotes, polls). Hooks written for first 1–2 seconds of every Reel.",
    audienceLogic: "Targeted urban women aged 22–34 interested in lifestyle, wellness, and aesthetic brands. Influencer tier: 10K–50K followers for credibility without high cost.",
    executionPoints: [
    ...
    budgetAllocation: "₹0 paid spend — 100% organic. Influencer cost: ₹8,000 total across 3 collabs.",
    toolsUsed: [
      "Canva",
      "Later",
      "Meta Insights",
    ...
    keyInsight: "Hooks drove everything. Reels with a clear tension or question in the first 2 seconds consistently outperformed polished content. Micro-influencers delivered 3× better engagement-to-cost ratio than macro options.",
    scaleNext: "Run paid amplification on top 3 organic Reels, launch a UGC seeding program, and build a WhatsApp broadcast list from DM traffic.",
    ocid: "case.item.1"
  },
  {
    ...
    objective: "Generate quality leads at a reduced CPL for an online coaching program targeting working professionals.",
    problem: "CPL was ₹210 — unsustainable for the unit economics. Creatives were generic, audience targeting was broad, and the landing page had a 72% bounce rate with no retargeting in place.",
    funnelDesign: "TOF: Broad interest + lookalike audiences with awareness creatives. MOF: Engaged video viewers and website visitors retargeted with social proof. BOF: Lead form ads and WhatsApp click-to-chat for warm audiences.",
    channelsUsed: [
      "Meta Ads (Facebook + Instagram)",
      "WhatsApp Click-to-Chat",
      "Landing Page Optimization"
    ],
    creativeApproach: "5 creative angles tested: pain-point hook, transformation story, tutor credibility, outcome-first, and objection-handling. Video + static split. Testimonial-led creatives used in retargeting phase.",
    audienceLogic: "Primary: Working professionals 25–40, interest in upskilling + career growth. Secondary: 1% lookalike from existing students. Retargeting: video viewers (50%+) and website visitors (last 30 days).",
    executionPoints: [
    ...
    budgetAllocation: "Total: ₹1.2L over 45 days. 50% TOF, 30% MOF retargeting, 20% BOF conversion.",
    toolsUsed: [
      "Meta Ads Manager",
      "GA4",
      "Canva",
    ...
    keyInsight: "The transformation-story creative outperformed all others by 2.4×. Audience specificity (working professionals, not just 'education interest') dropped CPL by 34% on its own. Retargeting with testimonials recovered 22% of drop-offs.",
    scaleNext: "Add Google Search ads to capture high-intent queries, build an email nurture sequence post-lead-capture, and test Reels as TOF creative format.",
    delay: "d1",
    ocid: "case.item.2"
  },
  {
    ...
    objective: "Build organic LinkedIn presence from 0 followers with consistent, hook-driven content that generates inbound interest.",
    problem: "Zero followers, no content cadence, no clear positioning. The profile was incomplete and not optimized for search or inbound discovery.",
    funnelDesign: "TOF: Hook-first posts for discovery and reach. MOF: Thought-leadership threads and commentary to build trust. BOF: DMs and profile visits converting to inbound inquiries.",
    channelsUsed: ["LinkedIn (Organic)", "LinkedIn Analytics", "DM Outreach"],
    creativeApproach: "Hook-first framework: every post opened with a contrarian statement, a number, or a clear tension. Post types: personal insight, case study snippets, industry commentary, mini-frameworks.",
    audienceLogic: "Target audience: founders, marketing managers, and startup hiring managers interested in growth and performance marketing. Niche down early to drive algorithmic distribution.",
    executionPoints: [
    ...
    budgetAllocation: "₹0 paid. Time investment: ~4 hrs/week across writing, scheduling, and engagement.",
    toolsUsed: [
      "LinkedIn Analytics",
      "Canva",
      "Notion",
    ...
    keyInsight: "Consistency beat virality. Posts published on a fixed cadence with strong hooks averaged 3× more impressions than sporadic 'viral attempt' posts. Commenting on niche creators drove 40% of new followers.",
    scaleNext: "Launch a LinkedIn newsletter for weekly distribution, add a lead magnet (free resource) linked from the profile, and repurpose top posts into short-form video.",
    delay: "d2",
    ocid: "case.item.3"
  }
];
...
const EXPERIENCE_CARDS = [
  {
    ...
    impact: "Built foundational skills across SEO, paid media, and multi-client execution"
  },
  {
    icon: "🎬",
  ...
  },
  {
    ...
    impact: "Managed 10+ brands across performance, content, and growth systems"
  }
];
function CaseCard({
  tags,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      children: [
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "case-tags", children: tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "case-tag-pill", children: t }, t)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "case-title", children: title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-meta", children: meta })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "case-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "case-sep" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "case-grid", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Objective" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: objective })
            ] }),
            strategy && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Strategy" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: strategy })
            ] }),
            problem && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Problem" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: problem })
            ] }),
            funnelDesign && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Funnel Design" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: funnelDesign })
            ] }),
            channelsUsed && channelsUsed.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Channels Used" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "case-tools", children: channelsUsed.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "case-tool-tag", children: c }, c)) })
            ] }),
            creativeApproach && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Creative Approach" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: creativeApproach })
            ] }),
            audienceLogic && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Audience Logic" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: audienceLogic })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Execution" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "case-text", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: executionPoints.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: p }, p)) }) })
            ] }),
            budgetAllocation && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Budget Allocation" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: budgetAllocation })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "Tools Used" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "case-tools", children: toolsUsed.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "case-tool-tag", children: t }, t)) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", style: { marginBottom: 14 }, children: "Results" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "case-metrics-grid", children: metrics.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "metric-chip", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "metric-value", children: m.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "metric-label", children: m.label })
          ] }, m.label)) }),
          keyInsight && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", style: { marginBottom: 6 }, children: "Key Insight" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: keyInsight })
              ]
            }
          ),
          scaleNext && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 16 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-section-label", children: "What I’d Scale Next" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "case-text", children: scaleNext })
          ] })
        ] })
      ]
    }
...
function ProofCard({
  ...
  const delayClass = delays[index2 % delays.length];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: `proof-card cursor-hover rv ${delayClass}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "proof-label", children: label }),
    context && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        style: {
          fontSize: "0.7rem",
...
function ExperienceCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref: cardRef,
      className: `exp-card rv d${index2 % 3 + 1}`,
      onMouseMove: handleMouseMove,
      onMouseLeave: handleMouseLeave,
      "data-ocid": `experience.item.${index2 + 1}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "exp-card-icon", children: card.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "exp-card-period", children: card.period }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "exp-card-role", children: card.role }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "exp-card-company", children: card.company }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "exp-card-desc", children: card.desc }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "exp-card-bullets", children: card.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: b }, b)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "exp-card-impact", children: card.impact })
      ]
    }
  );
}
function App() {
  ...
  const expTrackRef = reactExports.useRef(null);
  const [activeCard, setActiveCard] = reactExports.useState(0);
  const scrollToCard = (i) => {
    const track2 = expTrackRef.current;
    if (!track2) return;
    const cards = track2.querySelectorAll(".exp-card");
    const card = cards[i];
    if (card) {
      track2.scrollTo({
        left: card.offsetLeft - track2.offsetLeft,
        behavior: "smooth"
      });
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: `nav${scrolled ? " scrolled" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#hero", className: "nav-logo", "data-ocid": "nav.link", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: menuOpen ? "open" : "" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: menuOpen ? "open" : "" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: menuOpen ? "open" : "" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: `nav-links${menuOpen ? " open" : ""}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero", id: "hero", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "hero-eyebrow rv", children: [
        "Portfolio · ",
        year
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "hero-name rv d1", children: "Nithya Yennuwar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-role rv d2", "data-ocid": "hero.section", children: "Full-Stack Growth Marketer | Performance, Content & AI Systems" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-sep rv d2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-tagline rv d3", "data-ocid": "hero.panel", children: "I build scalable growth systems that turn content into revenue — combining paid media, organic strategy, and AI-driven execution." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-credibility rv d4", "data-ocid": "hero.card", children: "2.5+ years · YC-backed startup experience · 10+ brands · ₹40L+ revenue generated" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-ctas rv d4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#about", className: "btn-rust", "data-ocid": "hero.primary_button", children: "Explore ↓" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "#contact",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-scroll", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hero-scroll-label", children: "Scroll" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-scroll-line" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section glance", id: "glance", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "At a Glance" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glance-grid", children: GLANCE_CARDS.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `glance-card cursor-hover rv d${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "glance-number", children: c.number }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "glance-label", children: c.label })
          ]
        },
        c.label
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section about", id: "about", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-section-label rv", children: "About Me" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "about-quote-mark rv d1", children: "“" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "about-para rv", children: [
          "I’m a ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "full-stack growth marketer" }),
          " with 2.5+ years of experience operating across performance, content, and AI systems. As the sole marketing owner at Wuri — a YC-backed startup — I built and scaled 6+ channels end-to-end, from strategy through execution to optimization."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "about-para rv d1", children: [
          "Across a digital marketing agency, a media production house, and 10+ freelance brands, I’ve owned the full stack:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Meta + Google ad funnels, SEO from scratch, retention flows via Email + WhatsApp, influencer pipelines, and organic content systems." }),
          " ",
          "No hand-holding. No siloed roles."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "about-para rv d2", children: [
          "Currently open to",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "full-time roles, freelance projects, and consulting" }),
          " ",
          "engagements where ownership and outcomes are what matter."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "about-quote rv d3", children: "“I don’t just execute campaigns — I design systems, optimize funnels, and own outcomes end-to-end.”" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-badges rv d4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "about-badge", children: "YC-Backed Startup (Wuri)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "about-badge", children: "Film & Entertainment" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "about-badge", children: "Multi-Brand Freelance" })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section skills", id: "skills", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "Core Expertise" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "Core Skills" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skills-grid", children: SKILL_GROUPS.map((group, gi) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rv d${gi + 1}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "skill-group-label", children: group.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "skill-group-items", children: group.skills.map((s, si) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          s,
          si < group.skills.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "skill-dot", children: "·" })
        ] }, s)) })
      ] }, group.label)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section tools", id: "tools", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "My Stack" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "Tools & Platforms" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tools-grid", children: TOOL_CATEGORIES.map((cat, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `tool-category rv d${i % 3 + 1}`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "tool-cat-label", children: cat.label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tool-pills", children: cat.tools.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tool-pill", children: t }, t)) })
      ] }, cat.label)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section proof", id: "proof", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "Proof of Work" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "Results That Speak" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "proof-grid", children: PROOF_METRICS.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ProofCard,
        {
          number: m.number,
          label: m.label,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section cases", id: "work", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "Deep Dives" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "Campaign Case Studies" }),
      CASE_STUDIES.map((cs) => /* @__PURE__ */ jsxRuntimeExports.jsx(CaseCard, { ...cs }, cs.ocid))
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section ai-section", id: "ai", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "Key Differentiator" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "AI × Marketing Systems" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ai-intro rv d2", children: "I don’t just use AI tools — I build systems that scale marketing." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ai-grid", children: AI_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `ai-card cursor-hover rv d${i + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "ai-card-title", children: card.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ai-card-text", children: card.text })
          ]
        },
        card.title
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ai-callout rv d3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ai-callout-number", children: "18 hrs/wk" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ai-callout-label", children: "saved using AI automation" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section industry", id: "industry", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "Verticals" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "Industry Experience" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "industry-grid", children: INDUSTRY_TILES.map((tile, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `industry-tile cursor-hover rv d${i % 3 + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "industry-icon", children: tile.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "industry-title", children: tile.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "industry-text", children: tile.text })
          ]
        },
        tile.title
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section philosophy", id: "philosophy", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "How I Think" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "Work Philosophy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "philosophy-grid", children: PHILOSOPHY_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `philosophy-card cursor-hover rv d${i % 2 + 1}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "philosophy-num", children: card.num }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "philosophy-title", children: card.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "philosophy-text", children: card.text })
          ]
        },
        card.num
      )) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section journey", id: "journey", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-eyebrow rv", children: "Career Timeline" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title rv d1", children: "Experience & Journey" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "exp-subtitle rv d2", children: "A timeline of how I built my growth marketing expertise across startups, media, and multi-brand environments." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "exp-scroll-wrapper", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "exp-track",
            ...
            onScroll: () => {
              ...
              const cards = Array.from(
                track2.querySelectorAll(".exp-card")
              );
              let closest = 0;
              let minDist = Number.POSITIVE_INFINITY;
              cards.forEach((card, idx) => {
                const dist = Math.abs(
                  card.getBoundingClientRect().left - track2.getBoundingClientRect().left
                );
                if (dist < minDist) {
                  minDist = dist;
                  closest = idx;
            ...
            onMouseDown: (e) => {
              const track2 = expTrackRef.current;
              if (!track2) return;
              const startX = e.pageX - track2.offsetLeft;
              const startScroll = track2.scrollLeft;
              track2.dataset.dragging = "1";
              const onMove = (ev) => {
                if (track2.dataset.dragging !== "1") return;
                const x = ev.pageX - track2.offsetLeft;
                track2.scrollLeft = startScroll - (x - startX);
              };
              const onUp = () => {
                track2.dataset.dragging = "0";
            ...
            children: EXPERIENCE_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ExperienceCard, { card, index: i }, card.company))
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "exp-dots", children: EXPERIENCE_CARDS.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "section contact", id: "contact", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "contact-headline rv", children: "Let’s Build Something That Grows" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-sub rv d1", children: "Open to full-time roles, freelance projects, and consulting. Hyderabad · Immediate availability." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-cards", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "contact-card-icon", children: "✉️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-card-label", children: "Email" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-card-value", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: "mailto:nithayennuwar3112@gmail.com",
                  "data-ocid": "contact.link",
                  children: "nithayennuwar3112@gmail.com"
                }
              ) })
            ]
          }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "data-ocid": "contact.card",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "contact-card-icon", children: "📞" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-card-label", children: "Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-card-value", children: /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+917396584172", "data-ocid": "contact.link", children: "+91 73965 84172" }) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "contact-card-icon", children: "💼" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-card-label", children: "LinkedIn" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-card-value", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  "data-ocid": "contact.link",
                  children: "linkedin.com/in/nithya-yennuwar3112"
                }
              ) })
            ]
          }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-ctas rv d3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "mailto:nithayennuwar3112@gmail.com",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-location rv d4", children: "📍 Hyderabad · Immediately Available" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "footer-copy", children: [
        "© ",
        year,
        " Nithya Yennuwar. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "footer-caffeine", children: [
        "Built with ♥ using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
